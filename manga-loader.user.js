...
const createFormData = imgBlob => {
  ...
  formData.append('tgt_lang', "ENG");
  formData.append('target_language', "ENG");
...
// see for configuring cotrans (and modify createFormData function):
// https://github.com/zyddnys/manga-image-translator/blob/main/README.md#samples
const cotransTranslators = ['youdao', 'baidu', 'deepl', 'papago', 'caiyun', 'gpt3', 'gpt3.5', 'gpt4', 'none', 'original', 'sakura', 'deepseek', 'groq', 'offline', 'nllb', 'nllb_big', 'sugoi', 'jparacrawl', 'jparacrawl_big', 'm2m100', 'm2m100_big', 'mbart50', 'qwen2', 'qwen2_big'];
